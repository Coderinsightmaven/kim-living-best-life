      ...
      <div className="space-y-20">
        <ToolsSection title="Foods">
          ...
          <Tool title="FairLife Lactose Free Fat Free Ultra Filtered Milk">
            <Image
              className="pb-2"
              alt="FairLife Lactose Free Fat Free Ultra Filtered Milk"
          ...
          <Tool title="Rao's Homemade Tomato Basil Spaghetti Sauce">
            <Image
              className="pb-2"
              alt="Rao's Homemade Tomato Basil Spaghetti Sauce"
          ...
          <Tool title="BodyArmor Lyte Sports Drink">
            <Image
              className="pb-2"
              alt="BodyArmor Lyte Sports Drink"
          ...
          <Tool title="Frigo Cheese Heads Original Mozzarella String Cheese">
            <Image
              className="pb-2"
              alt="Frigo Cheese Heads Original Mozzarella String Cheese"
          ...
          <Tool title="The Berry that cares 1 U.S. Dry Pint (551 ml)">
            <Image
              className="pb-2"
              alt="The Berry that cares 1 U.S. Dry Pint (551 ml)"
          ...
          <Tool title="Good Culture Classic Simply Cottage Cheese Tub">
            <Image
              className="pb-2"
              alt="Good Culture Classic Simply Cottage Cheese Tub"
          ...
          <Tool title="Sargento Balanced Breaks, Variety Snack Pack">
            <Image
              className="pb-2"
              alt="Sargento Balanced Breaks, Variety Snack Pack"
          ...
          <Tool title="Three Bridges Ham and Gruyere Egg Bites">
            <Image
              className="pb-2"
              alt="Three Bridges Ham and Gruyere Egg Bites"
        ...
        <ToolsSection title="Supplements">
          <Tool title="MaryRuth Organics Nighttime Liquid Multimineral Sleep Supplement">
            <Image
              className="pb-2"
              alt="MaryRuth Organics Nighttime Liquid Multimineral Sleep Supplement"
              src="https://m.media-amazon.com/images/I/81gQ1OWRdbL._AC_SL1500_.jpg"
            />
          </Tool>
          <Tool title="Equate - Stool Softener 100 mg">
            <Image
              className="pb-2"
              alt="Equate - Stool Softener 100 mg"
              src="https://m.media-amazon.com/images/I/7197gvznfUL._AC_SL1500_.jpg"
            />
          </Tool>
          <Tool title="Nutricost Cissus Quadrangularis 600mg">
            <Image
              className="pb-2"
              alt="Nutricost Cissus Quadrangularis 600mg"
              src="https://m.media-amazon.com/images/I/610nmvwUqVL._AC_SL1500_.jpg"
            />
          </Tool>
          <Tool title="Nordic Naturals Vitamin D3 + K2 Gummies, Pomegranate - 60 Gummies">
            <Image
              className="pb-2"
              alt="Nordic Naturals Vitamin D3 + K2 Gummies, Pomegranate - 60 Gummies"
              src="https://m.media-amazon.com/images/I/61zkoxQ6isL._AC_SL1500_.jpg"
            />
          </Tool>
          <Tool title="Source Naturals Essential Enzymes 500mg">
            <Image
              className="pb-2"
              alt="Source Naturals Essential Enzymes 500mg"
              src="https://m.media-amazon.com/images/I/71fYJVSxl7L._AC_SL1500_.jpg"
            />
          </Tool>
          <Tool title="Bloom Nutrition Greens & Superfoods Powder, Mixed Berry, 25 Servings">
            <Image
              className="pb-2"
              alt="Bloom Nutrition Greens & Superfoods Powder, Mixed Berry, 25 Servings"
              src="https://m.media-amazon.com/images/I/61OQcccGwAL._AC_SL1050_.jpg"
            />
          </Tool>
          <Tool title="Ultima Replenisher Daily Electrolyte Drink Mix Grape, 20 Stickpacks">
            <Image
              className="pb-2"
              alt="Ultima Replenisher Daily Electrolyte Drink Mix Grape, 20 Stickpacks"
              src="https://m.media-amazon.com/images/I/61dh1Eqvl8L._SL1500_.jpg"
            />
          </Tool>
        </ToolsSection>
      </div>
